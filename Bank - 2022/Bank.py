...
PhoneNum = int(input("Enter the home phone number: "))
CellNum = int(input("Enter the cell phone number: "))
MemShipType = input("Enter the Membership type(S,E): ")
AltMem = int(input("Enter the number of alternate members: "))
WeeklySiteClean = input("Weekly site cleaning?(Y/N): ")
VideoSur = input("Video Surveillance?(Y/N): ")
...
print()
print()
print(" "*25,      "St. John's Marina & Yacht Club")
print(" "*28,        "Yearly Member Reciept")
print()
